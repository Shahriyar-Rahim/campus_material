    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          ...
          <input name="studentId" value={form.studentId} onChange={handleChange} className="input" placeholder="CSE2201001" required />
        </div>
        <div>
      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        <div>
          ...
          <select name="level" value={form.level} onChange={handleChange} className="input" required>
            <option value="">–</option>
        ...
        <div>
          ...
          <select name="term" value={form.term} onChange={handleChange} className="input" required>
            <option value="">–</option>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          ...
          <input name="session" value={form.session} onChange={handleChange} className="input" placeholder="WINTER 2026" required />
        </div>
        <div>
          <label className="mb-1 block text-sm font-medium text-gray-700">Batch</label>
          <input name="batch" value={form.batch} onChange={handleChange} className="input" placeholder="58th" required />
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          ...
          <input name="password" type="password" value={form.password} onChange={handleChange} className="input" placeholder="Min 8 chars" required />
        </div>
        <div>
